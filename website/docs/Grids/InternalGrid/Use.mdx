...
| gridGap             | Création de la grille  |          ❌          |          ✔️          |
...
Le composant **InternalGrid** dans son ensemble peut être aligné à l'intérieur de son parent, à condition que sa largeur soit inférieur à celle de son parent, grâce aux 2 props ci-dessous&nbsp;:
...
```css
.internal-grid > * { /* Tous les enfants directs de la classe .internal-grid sont ciblés */
    margin-top: 8px;
}
```
