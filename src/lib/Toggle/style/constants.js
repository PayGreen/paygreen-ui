const color = {
    main: {
        base: {
            ...
            status: props => props.theme.color.status.danger.main,
        },
        checked: {
            theme: props => props.theme.color[props.colorTheme].main,
            wab: props => props.theme.color.status[props.colorStatus].main,
    ...
    bg: {
        base: {
            ...
            status: props => props.theme.color.status.danger.light,
        },
        checked: {
            theme: props => props.theme.color[props.colorTheme].light,
            wab: props => props.theme.color.status[props.colorStatus].light,
