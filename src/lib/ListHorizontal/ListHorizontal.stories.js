...
.add('ListHorizontal of Texts', () => (
    <ListHorizontal
        ...
        colorPallet={radios(colorPalletLabel, colorPalletOptions, colorPalletOptions.wab)}
        ...
        paddingLateral={select('Lateral paddings', spaceOptions, spaceOptions.sm)}
        paddingTop={select('Padding top', spaceOptions, spaceOptions.sm)}
        paddingBottom={select('Padding bottom', spaceOptions, spaceOptions.sm)}
    >
