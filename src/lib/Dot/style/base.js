...
const dotStyle = {
    circle: css`
        ...
        width: ${props => math(props.theme.icon.iconSize[props.dotSize] + '/2')};
        height: ${props => math(props.theme.icon.iconSize[props.dotSize] + '/2')};
        border-radius: 50%;
        ${backgroundColor};
    `,
    dash: css`
        display: inline-block;
        width: ${props => props.theme.icon.iconSize[props.dotSize]};
    ...
    slashes: css`
        ...
        width: ${props =>
            math(
                'sqrt((' +
                    props.theme.icon.iconSize[props.dotSize] +
                    '/' +
                    cos +
                    ')^2 - ' +
                    props.theme.icon.iconSize[props.dotSize] +
        ...
        &::after {
            ...
            height: ${props => props.theme.icon.iconSize[props.dotSize]};
