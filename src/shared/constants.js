...
const folder = {
    ...
    text: 'Texts & titles' + folderSeparator,

    sub: {
        daTable: 'DaTable' + folderSeparator,
        checkbox: 'Checkbox' + folderSeparator,
        footer: 'Footer' + folderSeparator,
        histogram: 'Histogram' + folderSeparator,
        list: 'Basic list' + folderSeparator,
        menu: 'Menu primary & secondary' + folderSeparator,
        modal: 'Modal' + folderSeparator,
        pagination: 'Pagination' + folderSeparator,
        radio: 'Radio' + folderSeparator,
        sidebarMenu: 'Sidebar' + folderSeparator,
        skeleton: 'Skeleton' + folderSeparator,
